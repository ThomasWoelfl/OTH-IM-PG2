	...
	public boolean checkWin() {
		...
		for (int y = 0; y < this.y; y++) {
			for (int x = 0; x < this.x - 3; x++) {
				if (gamefield[y][x] != ' ' && gamefield[y][x] == gamefield[y][x + 1] && gamefield[y][x] == gamefield[y][x + 2] && gamefield[y][x] == gamefield[y][x + 3]) {
					return true;
				}
			}
		}
		...
		for (int y = 0; y < this.y - 3; y++) {
			for (int x = 0; x < this.x; x++) {
				if (gamefield[y][x] != ' ' && gamefield[y][x] == gamefield[y + 1][x] && gamefield[y][x] == gamefield[y + 2][x] && gamefield[y][x] == gamefield[y + 3][x]) {
					return true;
				}
			}
		}
		...
		for (int y = 0; y < this.y - 3; y++) {
			for (int x = 0; x < this.x - 3; x++) {
				if (gamefield[y][x] != ' ' && gamefield[y][x] == gamefield[y + 1][x + 1] && gamefield[y][x] == gamefield[y + 2][x + 2]
						&& gamefield[y][x] == gamefield[y + 3][x + 3]) {
					return true;
				}
			}
		}
