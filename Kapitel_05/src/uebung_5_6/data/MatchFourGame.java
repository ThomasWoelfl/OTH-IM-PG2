...
public class MatchFourGame {
	 ...
	 */
	public void makeMove(Scanner scanner) throws ChoiceNotInFieldException, ColumnIsFullException, FieldIsFullException {

		System.out.println("Spieler " + this.activePlayer.getName() + " ist am Zug" + " (Zeichen " + this.activePlayer.getPlayStone() + ").");
